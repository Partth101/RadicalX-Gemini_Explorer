...
#     # Replace "," with "." to separate user name with a full stop
...
# # Clear the chat history after getting the user name
# st.session_state.messages = []

# # Capture the user's name
# user_name = st.text_input("Please enter your name")

# # Display initial prompt and load chat history only after getting the name
# if user_name:
...
# query = st.chat_input("")  # Empty string for initial input field
